  ...
  <div>
    ...
    <div v-if="$$data">
      ...
      <div class="row">
        ...
        >
          <el-option
            v-for="item in $$data.zones"
            :key="item"
            :label="$store.state.overseas_common.regionMap[item] || item"
            :value="$store.state.overseas_common.regionMap[item] || item"
          >
          </el-option>
        </el-select>
        <el-button
      ...
      <div class="table-item">
        ...
        <el-table
          :default-sort="{prop: $data.$_sortKey, order: $data.$_order}"
          :data="$$data.list"
          :cell-style="addStyle"
        ...
        >
          <el-table-column
            v-for="(item, i) in $$config.tableKey"
            :key="i"
            :prop="item.key"
            :label="item.key"
