    ...
    methods: {
        ...
        changeBtn(){
            ...
            if (this.zoneActivityIndex>=0) {                
                this.$store.commit('o_r_channel_status/setZoneID',this.$$zoneList.zoneNameArr[this.areaActiveIndex][this.channelActiveIndex][this.zoneActivityIndex].gamezone_id)
                this.$store.commit('o_r_channel_status/setZoneName',this.$$zoneList.zoneNameArr[this.areaActiveIndex][this.channelActiveIndex][this.zoneActivityIndex].gamezone_name)
            }else{
                if (this.channelActiveIndex>=0) {
                    this.$store.commit('o_r_channel_status/setZoneID', this.$$zoneList.zoneNameArr[this.areaActiveIndex][this.channelActiveIndex][0].agent_id)
                    this.$store.commit('o_r_channel_status/setZoneName',this.$$zoneList.channelArr[this.areaActiveIndex][this.channelActiveIndex])
                }else{
                    this.$store.commit('o_r_channel_status/setZoneID', this.$$zoneList.zoneNameArr[this.areaActiveIndex][0][0].region_id)
