...
export default {
    ...
    computed:{
        ...
        $$zoneList(){
            var data = this.$store.getters["o_r_overall/getZoneList"]; 
    ...
    methods: {
        close(){
            this.$store.commit("o_r_overall/setVisibleZone",false)
            this.dataInit()
            
        },
        changeBtn(){
            this.$store.commit("o_r_overall/setVisibleZone",false)
            this.$store.commit('o_r_overall/setAreaActiveIndex',this.areaActiveIndex)
